...
export const OTOWatchPageGa = () => {
  ...
  const utmSource = params.get('utm_source') || 'google_ads';
  ...
  const trackToSheet = async (status: string) => {
    try {
      ...
      const body = new URLSearchParams({
        name: fullName || sessionData.full_name || "NA",
        email: email || sessionData.email || "NA",
        phone: phone || sessionData.phone || "NA",
        profession: professionParam || sessionData.profession || "OTO_GA_LEAD",
        age_range: ageRangeParam || sessionData.age_range || "OTO_GA_LEAD",
        utm_source: utmSource,
        utm_campaign: "wristwatch_workshop_ga",
        utm_term: status,
        utm_content: "",
      });
  ...
  const handleContinue = async () => {
    ...
    if (choice === 'yes') {
      ...
      const result = await initiatePayment({
        ...
        notes: {
          ...utmParams,
          age_range: ageRangeParam || sessionData.age_range,
          profession: professionParam || sessionData.profession,
